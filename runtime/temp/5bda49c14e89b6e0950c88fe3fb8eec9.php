<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\xampp\htdocs\test\public/../application/app\view\apidoc\index.html";i:1522072400;s:58:"D:\xampp\htdocs\test\application\app\view\public\base.html";i:1521977749;s:58:"D:\xampp\htdocs\test\application\app\view\public\head.html";i:1521977407;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script src="/static/assets/js/zTree_v3/js/jquery.ztree.core-3.5.min.js" type="text/javascript"></script>
<link href="/static/assets/js/zTree_v3/css/zTreeStyle/zTreeStyle.css" rel="stylesheet" />
<style type="text/css">
...
<div class="zt_main">
    ...
    <div class="zt_content" style="overflow: hidden;">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="index_tab_content"><iframe id="zt_text" src="<?php echo url('search'); ?>" width="100%" height="100%" frameborder="0"></iframe></div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function loadText(tab_id, title, name){
        ...
        $(content_text).attr("src","<?php echo url('getInfo'); ?>".replace('.html','')+'?name='+name);
        initHeight();
    }
    var zTree;
