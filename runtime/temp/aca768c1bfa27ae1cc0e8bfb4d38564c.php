<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\xampp\htdocs\test\public/../application/app\view\apidoc\search.html";i:1521984432;s:58:"D:\xampp\htdocs\test\application\app\view\public\base.html";i:1521977749;s:58:"D:\xampp\htdocs\test\application\app\view\public\head.html";i:1521977407;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    $(function () {
        $('#search_input').typeahead({
            source: function (query, process) {
                $.getJSON("<?php echo url('search'); ?>", { "query": query }, function(data){
                    var items = [];
        ...
        $('#search').click(function(){
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo url('search'); ?>"+"?query="+query,
                dataType:'json',
